  ...
  return (
    <div>
      ...
      <div className="mt-4 max-w-2xl">
        <p className="mb-3">The Tradefinder is web tool to find the most profitable trades between two locations, where one is selling a good and another is buying that good at a higher price. Additionally, you may specify the amount that can be bought or sold.<br/>Trades which are not profitable are discarded.</p>
